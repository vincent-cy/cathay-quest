...
const surveyQuestions = [
  {
    ...
    options: [
      ...
      { id: "nature", label: "Nature & Outdoors", icon: Compass, description: "Hiking, beaches, and natural landscapes" },
      { id: "nightlife", label: "Nightlife & Entertainment", icon: Moon, description: "Clubs, bars, and entertainment venues" },
      { id: "art", label: "Art & Design", icon: Palette, description: "Museums, galleries, and architecture" },
      { id: "social", label: "Social & People", icon: UsersIcon, description: "Meeting locals and making connections" },
    ]
  },
  {
    id: "sustainability",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "water", label: "Water Sports", icon: Wifi, description: "Swimming, diving, surfing" },
      { id: "reading", label: "Reading & Learning", icon: BookOpen, description: "Books, podcasts, educational content" },
      { id: "business", label: "Business & Networking", icon: Briefcase, description: "Conferences and professional meetings" },
      { id: "gaming", label: "Gaming & Tech", icon: Shield, description: "Video games and tech experiences" },
      { id: "wellness", label: "Wellness & Spa", icon: Sun, description: "Spa, meditation, yoga" },
      { id: "adventureSports", label: "Adventure Sports", icon: Compass, description: "Climbing, paragliding, etc." },
    ]
  },
  {
    id: "frequency",
  ...
  },
  {
    ...
    multiSelect: false,
    options: [
      { id: "weekend", label: "Weekend Getaway", icon: Sun, description: "2-3 days" },
      { id: "shortWeek", label: "Short Week", icon: Calendar, description: "4-7 days" },
      { id: "longWeek", label: "Long Duration", icon: Clock, description: "1-3 weeks" },
      { id: "extended", label: "Extended Travel", icon: Compass, description: "More than a month" },
    ]
  },
  {
    id: "accessibility",
    ...
    minSelections: 1,
    options: [
      { id: "mobility", label: "Mobility Access", icon: Accessibility, description: "Wheelchair & accessibility features" },
      { id: "dietary", label: "Dietary Requirements", icon: Utensils, description: "Special meal options available" },
      { id: "quiet", label: "Quiet Spaces", icon: Moon, description: "Peaceful areas to relax" },
      { id: "family", label: "Family-Friendly", icon: UsersIcon, description: "Activities for families with children" },
      { id: "petFriendly", label: "Pet-Friendly", icon: Heart, description: "Pet accommodations" },
      { id: "language", label: "Language Support", icon: BookOpen, description: "Multiple language assistance" },
      { id: "visual", label: "Visual Assistance", icon: Eye, description: "Support for visually impaired" },
      { id: "elderly", label: "Elderly Support", icon: Heart, description: "Facilities for elderly travelers" },
      { id: "none", label: "None", icon: Shield, description: "No accessibility features needed" },
    ]
  },
  {
    id: "rewards",
    ...
    minSelections: 1,
    options: [
      { id: "miles", label: "Frequent Flyer Miles", icon: Plane, description: "Asia Miles accumulation" },
      { id: "discounts", label: "Travel Discounts", icon: TrendingUp, description: "Reduced flight & hotel costs" },
      { id: "upgrades", label: "Flight Upgrades", icon: Shield, description: "Seat and cabin upgrades" },
      { id: "experiences", label: "Exclusive Experiences", icon: Trophy, description: "VIP events and lounges" },
      { id: "wifi", label: "Free Wi-Fi", icon: Wifi, description: "Complimentary internet access" },
      { id: "global", label: "Global Lounge Access", icon: Globe, description: "Access to airport lounges worldwide" },
      { id: "cashback", label: "Cashback/Vouchers", icon: Heart, description: "Direct payment or gift cards" },
      { id: "status", label: "Elite Status", icon: Trophy, description: "Unlock elite status and perks" },
    ]
  },
  {
    id: "groupTravel",
    ...
    multiSelect: false,
    options: [
      { id: "solo", label: "Solo", icon: UsersIcon, description: "I prefer traveling alone" },
      { id: "partner", label: "With a partner", icon: UsersIcon, description: "I travel with one other person" },
      { id: "family", label: "With family", icon: UsersIcon, description: "I travel with family" },
      { id: "friends", label: "With friends", icon: UsersIcon, description: "I travel with a group of friends" },
      { id: "colleagues", label: "With colleagues", icon: Briefcase, description: "I travel for work with colleagues" },
    ]
  }
];
  ...
  const isAnswered =
    currentQuestion.multiSelect
      ? (
          ...
          (responses[currentQuestion.id].length >= (currentQuestion.minSelections ?? 1))
        )
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-96 overflow-y-auto pr-2">
            {currentQuestion.options.map((option) => {
              ...
              const isSelected = currentQuestion.multiSelect
                ? Array.isArray(responses[currentQuestion.id]) && responses[currentQuestion.id].includes(option.id)
          ...
          {currentQuestion.multiSelect && (
            <div className="text-sm text-muted-foreground text-center">
              {Array.isArray(responses[currentQuestion.id]) ? responses[currentQuestion.id].length : 0} of {currentQuestion.maxSelections} selected
