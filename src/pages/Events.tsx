...
const communityMilestones = [
  {
    ...
    description: "Receive lifetime priority boarding and complimentary lounge access on all future flights with our partner airlines",
    reward: "1000 Points + Lifetime Priority Perks",
    status: "LOCKED",
    funded: false,
    position: "right"
  },
  {
    ...
    description: "Unlock free seat upgrades for your next 5 flights plus exclusive access to premium airport lounges worldwide",
    reward: "$100 Travel Credit + 5 Upgrades",
    status: "LOCKED",
    funded: false,
    position: "left"
  },
  {
    ...
    description: "Get 50% off baggage fees for an entire year and enjoy complimentary Wi-Fi on all international flights",
    reward: "$50 Travel Credit + 1 Year Baggage Discount",
    status: "IN PROGRESS",
    funded: false,
    currentAmount: 27500,
    position: "right"
  },
  {
    ...
    description: "Receive two complimentary meal vouchers valid on any flight plus priority check-in access for 6 months",
    reward: "$25 Dining Credit + Priority Check-in",
    status: "FUNDED",
    funded: true,
    position: "left"
  },
  {
    ...
    description: "Enjoy three free checked bags on your next trip and get early access to exclusive quest releases",
    reward: "$15 Baggage Credit + Early Quest Access",
    status: "FUNDED",
    funded: true,
    position: "right"
  },
  {
    ...
    description: "Redeem a $10 voucher for premium snacks and beverages on any flight plus double points on weekend quests",
    reward: "$10 Snack Voucher + 2x Weekend Points",
    status: "FUNDED",
    funded: true,
    position: "left"
  },
  {
    ...
    goalNum: 5000,
    title: "First Steps",
    description: "Claim a $5 coupon for in-flight meals and unlock access to bonus daily quests in your region",
    reward: "$5 Meal Coupon + Bonus Quests",
    status: "FUNDED",
    funded: true,
    position: "right"
  },
  {
    ...
    description: "Welcome bonus for early adopters - receive double points on your first 3 completed quests this month",
    reward: "50 Points + First Quest Bonus",
    status: "FUNDED",
    funded: true,
    position: "left"
  }
