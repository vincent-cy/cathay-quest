...
const communityMilestones = [
  {
    ...
    goalNum: 50000,
    title: "Quest Master",
    description: "Points and Lounge voucher",
    reward: "500 Points + Lounge Voucher",
    status: "LOCKED",
    funded: false,
    position: "right"
  },
  {
    ...
    description: "Two travel discount vouchers",
    reward: "2x$20 Travel Credit Vouchers",
    status: "LOCKED",
    funded: false,
    position: "left"
  },
  {
    ...
    description: "Seat Upgrade Discount + Wi-Fi pass",
    reward: "$20 Seat Upgrade Discount + 3h Wi-Fi Pass",
    status: "IN PROGRESS",
    funded: false,
    currentAmount: 27500,
    position: "right"
  ...
  },
  {
    ...
    description: "Baggage voucher + Refreshes",
    reward: "$6 Baggage Voucher + 3 refreshes",
    status: "FUNDED",
    funded: true,
    position: "right"
  },
  {
    ...
    description: "Snack voucher + Weekend bonus",
    reward: "$4 Snack Voucher + 1.5x Weekend Bonus",
    status: "FUNDED",
    funded: true,
    position: "left"
  },
  {
    ...
    goalNum: 5000,
    title: "First Steps",
    description: "Snack Coupon + Bonus Quest",
    reward: "$5 Snack Coupon + Bonus Quest",
    status: "FUNDED",
    funded: true,
    position: "right"
  },
